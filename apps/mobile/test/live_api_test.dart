// Contract check of the Dart API layer against a REAL running backend (apps/api, seeded).
// Skipped unless a base URL is given, e.g.:
//   flutter test test/live_api_test.dart --dart-define=THY_API_BASE_URL=http://localhost:3333
import 'dart:typed_data';

import 'package:flutter_test/flutter_test.dart';
import 'package:thy_business/core/api/api_client.dart';
import 'package:thy_business/core/api/api_exception.dart';
import 'package:thy_business/core/api/request_id.dart';
...
Future<ApiClient> _loggedInClient() async {
  ...
  final tokens = await auth.login(phone: '+224600000000', password: 'Demo1234!');
  ...
  group(
    ...
    () {
      ...
      test('checkout is idempotent; credit sales and voiding work through the real API', () async {
        ...
        final business = await BusinessApi(client.dio).current();
