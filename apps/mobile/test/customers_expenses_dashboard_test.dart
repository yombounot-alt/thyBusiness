...
import 'package:thy_business/features/customers/application/reminder_text.dart';
...
void main() {
  group('models and helpers', () {
    ...
    test('expense periods cover the right calendar days', () {
      ...
      expect(ExpensePeriod.today.range(now), (from: DateTime(2026, 9, 19), to: DateTime(2026, 9, 19)));
      expect(ExpensePeriod.week.range(now), (from: DateTime(2026, 9, 13), to: DateTime(2026, 9, 19)));
  ...
  group('Clients', () {
    ...
    testWidgets('paying back more than is owed is refused before calling the server', (tester) async {
      await openMamadou(tester);
    ...
    testWidgets('Créances totals what is owed, flags late debts and opens the customer', (tester) async {
  ...
  group('Accueil (tableau de bord)', () {
    ...
    testWidgets('shows the key figures, the finance breakdown and the best sellers', (tester) async {
