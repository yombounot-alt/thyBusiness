...
import 'package:thy_business/features/pos/application/cart.dart';
import 'package:thy_business/features/products/data/product_models.dart';
import 'package:thy_business/features/sales/application/receipt_text.dart';
...
VoidCallback? confirmCallback(WidgetTester tester) {
  return tester.widget<ElevatedButton>(find.widgetWithText(ElevatedButton, 'Confirmer le paiement')).onPressed;
}
...
void main() {
  ...
  setUp(() {
    catalog = [
      testProduct(id: 'p1', name: 'Eau minérale 1.5L', stock: 10, salePrice: 5000, barcode: '6001234000011'),
      testProduct(id: 'p2', name: 'Sucre en poudre 1kg', stock: 2, salePrice: 8500, sku: 'SUC-1KG'),
      testProduct(id: 'p3', name: 'Produit épuisé', stock: 0, salePrice: 1000, barcode: '6001234000035'),
    ];
  ...
  group('Caisse — barcode reader (keyboard scanner: code + Enter)', () {
    ...
    testWidgets('a scanned barcode goes straight into the cart and the field is ready again', (tester) async {
      await pumpPos(tester);
