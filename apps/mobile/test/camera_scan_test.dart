...
import 'package:thy_business/core/scanning/scan_types.dart';
...
void main() {
  ...
  group('Caisse: scanning a basket with the camera', () {
    testWidgets('every code read goes into the cart, and the scanner says what happened', (tester) async {
    ...
    testWidgets('the camera button is not offered where there is no camera scanning (browser)', (tester) async {
