...
import 'package:thy_business/core/api/api_exception.dart';
import 'package:thy_business/core/api/paginated.dart';
import 'package:thy_business/core/media/photo_picker.dart';
import 'package:thy_business/core/providers.dart';
import 'package:thy_business/core/scanning/barcode_scanner.dart';
import 'package:thy_business/core/storage/local_store.dart';
import 'package:thy_business/core/sharing/file_sharer.dart';
import 'package:thy_business/core/sharing/text_sharer.dart';
import 'package:thy_business/core/storage/token_storage.dart';
import 'package:thy_business/features/auth/application/auth_controller.dart';
import 'package:thy_business/features/auth/data/auth_api.dart';
import 'package:thy_business/features/auth/data/auth_models.dart';
import 'package:thy_business/features/categories/application/categories_providers.dart';
import 'package:thy_business/features/categories/data/categories_api.dart';
import 'package:thy_business/features/business/application/business_providers.dart';
import 'package:thy_business/features/business/data/business_api.dart';
import 'package:thy_business/features/categories/data/category_models.dart';
import 'package:thy_business/features/customers/application/customers_providers.dart';
import 'package:thy_business/features/customers/data/customer_models.dart';
import 'package:thy_business/features/customers/data/customers_api.dart';
import 'package:thy_business/features/dashboard/application/dashboard_providers.dart';
import 'package:thy_business/features/dashboard/data/dashboard_api.dart';
import 'package:thy_business/features/dashboard/data/dashboard_models.dart';
import 'package:thy_business/features/expenses/application/expenses_providers.dart';
import 'package:thy_business/features/expenses/data/expense_models.dart';
import 'package:thy_business/features/expenses/data/expenses_api.dart';
import 'package:thy_business/features/inventory/application/inventory_providers.dart';
import 'package:thy_business/features/inventory/data/inventory_api.dart';
import 'package:thy_business/features/inventory/data/inventory_models.dart';
import 'package:thy_business/features/payments/application/payments_providers.dart';
import 'package:thy_business/features/payments/data/payment_method_models.dart';
import 'package:thy_business/features/payments/data/payment_models.dart';
import 'package:thy_business/features/payments/data/payments_api.dart';
import 'package:thy_business/features/products/application/products_providers.dart';
import 'package:thy_business/features/products/data/product_models.dart';
import 'package:thy_business/features/products/data/products_api.dart';
import 'package:thy_business/features/sales/application/receipt_pdf.dart';
import 'package:thy_business/features/sales/application/sales_providers.dart';
import 'package:thy_business/features/sales/offline/sales_sync_service.dart';
import 'package:thy_business/features/sales/data/sale_models.dart';
import 'package:thy_business/features/sales/data/sales_api.dart';
...
class FakeAuthApi extends AuthApi {
  FakeAuthApi({this.role = 'owner'}) : super(Dio());

  /// The user's role in the business: only an owner manages payment settings and verifies payments.
  final String role;
  ...
  Future<UserProfile> me() async {
    ...
    return UserProfile(
      ...
      businesses: [
        BusinessSummary(id: 'biz-1', name: 'Boutique Demo', currency: 'GNF', role: role),
      ],
    );
  }
}
...
class FakeCustomersApi extends CustomersApi {
  ...
  Future<void> grantCredit(
    ...
    creditsByCustomer.putIfAbsent(customerId, () => []).add(
      testCredit(
...
class FakeDashboardApi extends DashboardApi {
  FakeDashboardApi({DashboardSummary? summary}) : summaryToReturn = summary ?? emptySummary, super(Dio());
...
class FakeBusinessApi extends BusinessApi {
  ...
  @override
  Future<BusinessDetails> current() async {
  ...
  Future<Sale> checkout(CheckoutRequest request) async {
    ...
    final sale = Sale(
      ...
      customer: customer == null
          ? null
          : SaleCustomer(id: customer.id, fullName: customer.fullName),
      items: items,
...
class FakePaymentsApi extends PaymentsApi {
  FakePaymentsApi({required this.sales, required this.catalog, required this.options}) : super(Dio());
  ...
  static String _key(String reference) => reference.toLowerCase().replaceAll(RegExp(r'[^a-z0-9]'), '');
...
Future<void> pumpAuthenticatedApp(
  ...
  await tester.pumpWidget(
    ProviderScope(
      overrides: [
        tokenStorageProvider.overrideWithValue(tokenStorage ?? FakeTokenStorage(access: 'a', refresh: 'r')),
