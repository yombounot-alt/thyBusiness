...
import 'package:thy_business/features/products/presentation/product_photo.dart';
...
void main() {
  ...
  Future<void> openEditFormOf(WidgetTester tester, String productName, FakePhotoPicker picker) async {
    await pumpAuthenticatedApp(tester, products: productsApi, photoPicker: picker);
    await openStockTab(tester);
  ...
  group('Showing photos', () {
    testWidgets('the Stock list shows the photo when there is one, the initial otherwise', (tester) async {
