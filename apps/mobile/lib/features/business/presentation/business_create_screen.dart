...
class _BusinessCreateScreenState extends ConsumerState<BusinessCreateScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final result = await ref.read(businessApiProvider).create(
      ...
      await ref.read(authControllerProvider.notifier).onBusinessCreated(result.tokens);
