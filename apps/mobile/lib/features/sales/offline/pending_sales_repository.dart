...
class PendingStock {
  ...
  @override
  bool operator ==(Object other) => other is PendingStock && mapEquals(other.quantities, quantities);

  @override
  int get hashCode => Object.hashAllUnordered(quantities.entries.map((e) => Object.hash(e.key, e.value)));
}
