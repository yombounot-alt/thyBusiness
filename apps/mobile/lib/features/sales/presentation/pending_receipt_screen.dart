          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                FilledButton(onPressed: () => context.go('/sales'), child: const Text('Historique')),
              ],
            ),
          ),
        ),
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (_) => const [
              PopupMenuItem(value: 'delete', child: Text('Supprimer cette vente')),
            ],
          ),
        ],
      ),
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  failed
                      ? 'Le serveur a refusé cette vente'
                      : 'Vente enregistrée sur ce téléphone',
