...
class _ProductFormState extends ConsumerState<_ProductForm> {
  ...
  bool get _hasPhoto =>
      _newPhoto != null || (widget.product?.hasImage == true && !_removePhoto);
  ...
  void initState() {
    ...
    _purchasePrice = TextEditingController(text: p == null ? null : formatQuantity(p.purchasePrice));
  ...
  Future<void> _choosePhoto() async {
    ...
    final PhotoSource? source = kIsWeb
        ? PhotoSource.gallery
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            if (_hasPhoto) TextButton(onPressed: _clearPhoto, child: const Text('Retirer la photo')),
          ],
        ),
      ],
    );
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: ref.watch(cameraScanningAvailableProvider)
                        ? IconButton(
