...
const _publicRoutes = {'/onboarding', '/login', '/signup', '/otp-verify'};

/// Screens that only make sense before a session is fully set up.
const _preSessionRoutes = {..._publicRoutes, '/splash', '/business/create'};
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/pos/pay',
        builder: (context, state) =>
            ChoosePaymentScreen(customer: state.extra is Customer ? state.extra as Customer : null),
      ),
      GoRoute(
      ...
      GoRoute(
        path: '/payments',
        builder: (context, state) => PaymentsScreen(initialStatus: state.uri.queryParameters['status']),
      ),
      GoRoute(
        path: '/payments/:id',
      ...
      GoRoute(path: '/settings/payment-methods', builder: (context, state) => const PaymentOptionsScreen()),
      // '/new' must stay above '/:id'.
      GoRoute(path: '/settings/payment-methods/new', builder: (context, state) => const PaymentOptionFormScreen()),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) => PendingReceiptScreen(
      ...
      GoRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: 'stock',
            builder: (context, state) =>
                StockMovementScreen(productId: state.pathParameters['id']!),
          ),
        ],
      ),
    ],
